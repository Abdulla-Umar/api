...
var store = new ProductModel_1.ProductModel();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.create(newProduct)];
            case 2:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 4];
...
var ProductRoutes = function (app) {
    ...
    app.delete("/products/:id", Users_1.verifyAuthToken, Delete);

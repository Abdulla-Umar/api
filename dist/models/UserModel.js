...
var _a = process.env, SALT_ROUNDS = _a.SALT_ROUNDS, BCRYPT_PEPPER = _a.BCRYPT_PEPPER;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1.default.hashSync(u.password + BCRYPT_PEPPER, parseInt(SALT_ROUNDS));
                        return [4 /*yield*/, conn.query(sql, [u.first_name, u.last_name, u.username, hash])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (result.rows.length) {
                            user = result.rows[0];
                            if (bcrypt_1.default.compareSync(password + BCRYPT_PEPPER, user.password)) {
                                return [2 /*return*/, user];
                            }
                        }

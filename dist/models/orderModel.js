...
var OrderModel = /** @class */ (function () {
    ...
    //     }
    //   }
    OrderModel.prototype.getCurrentOrderByUser = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT status,user_id,quantity,order_id,product_id FROM orders INNER JOIN order_products ON orders.id = order_products.order_id WHERE user_id=($1)';
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not get order : ".concat(error_1));
